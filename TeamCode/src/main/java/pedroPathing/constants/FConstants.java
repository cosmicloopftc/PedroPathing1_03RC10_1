...
public class FConstants {
    static {
        ...
        FollowerConstants.leftFrontMotorDirection = DcMotorSimple.Direction.REVERSE;    //TODO
        FollowerConstants.leftRearMotorDirection = DcMotorSimple.Direction.REVERSE;     //TODO
        FollowerConstants.rightFrontMotorDirection = DcMotorSimple.Direction.FORWARD;   //TODO
        FollowerConstants.rightRearMotorDirection = DcMotorSimple.Direction.FORWARD;    //TODO

        FollowerConstants.mass = 12.2;      // default 13;

        FollowerConstants.xMovement = 58;   // default 57.8741;     //v1=60; section 4.1 ForwardVelocityTuner 12/15/2024, battery V=13.6
        FollowerConstants.yMovement = 46;//TODO   // default 52.295;      //V1=46; section 4.2 Strafe VelocityTuner 12/15/2024, battery V=13.6

        FollowerConstants.forwardZeroPowerAcceleration = -41.278;   //TODO  //V1=-37; section 5.1 forwardZeroPowerAccelerationTuner 12/15/2024, battery V=13.5
        FollowerConstants.lateralZeroPowerAcceleration = -59.7819;  //TODO //V1=-65 (variable -63 to -68)  section 5.2 lateralZeroPowerAccelerationTuner 12/15/2024, battery V=13.5
        ...
        FollowerConstants.zeroPowerAccelerationMultiplier = 4;      //TODO //V1=4
