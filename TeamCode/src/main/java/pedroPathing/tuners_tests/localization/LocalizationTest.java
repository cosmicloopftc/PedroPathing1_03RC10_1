...
//        double rx = gamepad1.right_stick_x;
        ...
        telemetryA.addData("heading (degrees)", Math.toDegrees(poseUpdater.getPose().getHeading()));
        telemetryA.addData("total heading (degrees)", Math.toDegrees(poseUpdater.getTotalHeading()));
        telemetryA.update();
