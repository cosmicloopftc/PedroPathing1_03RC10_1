 ...
 *  TODO:   Adjust  SAFE_DRIVE_SPEED... below for driver preference
 *          Adjust constants for our specific robot in SimplifiedOdometryRobot class: DRIVE_GAIN.. STRAFE...  YAW...
 *          Need to connect encoders to each drive motors as the motor is "drive using encoder" setting
 *              and so need to move the encoder of Odometry Pod to new locations.
 */
