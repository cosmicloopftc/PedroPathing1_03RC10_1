package SimplifiedOdoTest;

/** Created by Phil Malone. 2023.  FTC team "GEARS inc"
    This class illustrates my simplified Odometry Strategy.
    It implements basic straight line motions but with heading and drift controls to limit drift.
    See the readme for a link to a video tutorial explaining the operation and limitations of the code.

 YOUTUBE tutorial:
 Part 1: Overview. https://youtu.be/lpVG2Pl6RGY An introduction to the purpose of this FTC tutorial,
    and some of the caveats that are assumed in its application.
 Part 2: Autonomous. https://youtu.be/EV7n9rGcxF4 A walk-through of a sample Autonomous OpMode.
 Part 3: Teleoperation. https://youtu.be/X7RyAMbP240 A walk-through of a sample Telop. OpMode.
 Part 4: SimplifiedMecanumRobot Class. https://youtu.be/eWzGW7ZcPh8 A detailed walk-through of the
    hardware class itself, explaining how the class works and how to adapt it to your robot.
    Note: This walkthrough was created before the Robot class was renamed to be SimplifiedMecanumRobot
    so the sample works in OnBotJava.
 */
...
public class SimplifiedOdometryRobot {
    ...
    public void initialize(boolean showTelemetry)
    {
        ...
        leftFrontDrive  = setupDriveMotor("leftFront", DcMotor.Direction.REVERSE);          //TODO: reverse is correct for V2 robot 1/29/2025
        rightFrontDrive = setupDriveMotor("rightFront", DcMotor.Direction.FORWARD);
        leftBackDrive  = setupDriveMotor( "leftRear", DcMotor.Direction.REVERSE);           //TODO: reverse is correct for V2 robot 1/29/2025
        rightBackDrive = setupDriveMotor( "rightRear",DcMotor.Direction.FORWARD);
        imu = myOpMode.hardwareMap.get(IMU.class, "imu");

        // TODO:    Connect to the encoder channels using the name of that channel.
        driveEncoder = myOpMode.hardwareMap.get(DcMotor.class, "LeftEncoder");          //TODO: need to confirm name and direction
        strafeEncoder = myOpMode.hardwareMap.get(DcMotor.class, "Strafe");              //TODO: need to confirm name and direction
        ...
        // TODO:   Tell the software how the Control Hub is mounted on the robot to align the IMU XYZ axes correctly
        //  new setup of imu; Define and initialize IMU sensor on new Control Hub--new orientation of the control hub
...
//        imu.initialize(new IMU.Parameters(orientationOnRobot));
     ...
     */
    //TODO:  NEED encoder wire of each motor in order to use velocity feedback on the motor (so that proportional distance control can be used and not need for PID controller)
