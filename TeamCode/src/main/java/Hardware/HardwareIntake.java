...
//        Servo_Test = hardwareMap.get(Servo.class, "Servo_Test");
    ...
    public void intakeSlideOUT() {
        intakeSlideSetPositionPower(310,0.4); //TODO: find position and power
    }
    public void intakeSlideMID() {
        intakeSlideSetPositionPower(200,0.4); //TODO: find position and power
    }

    public void intakeDOWN(){
        intakeServoAxon.setPosition(0.92); //TODO: find correct position
    }
