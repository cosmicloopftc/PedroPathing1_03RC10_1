...
//                if (robot.Outtake.getOuttakeArmPosition() < 0.28) {
...
//                }
                if (gamepad1.a){
                    ...
                    robot.Intake.intakeServoAxon.setPosition(0.9); //down
                }
                else if (gamepad1.y){
...
//                }
//                else if (gamepad2.y){
//                    robot.Intake.intakeSlideSetPositionPower(310,1); //280 = middle 310 = high
//                }
