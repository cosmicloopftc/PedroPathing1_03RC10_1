...
public class RR_2AutoRedSpecimen_PushTestParallelMove extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder combine_preloadMove_BackPush2SpecToHome_CollectSpec1 = preloadScore.endTrajectory().fresh()
                ...
                .setReversed(true)
                .lineToYConstantHeading(-37.5, velFast, accMedium) //1st move back from submersible pole--slightly
                //mid poin in spline closer btw two end point X
                .splineToLinearHeading(new Pose2d(26,-55, Math.toRadians(-90)),  //spline to side before going to sample4
...
//                .splineToLinearHeading(new Pose2d(35,-35, Math.toRadians(-90)),  //spline to side before going to sample4
//                        Math.toRadians(60), velFast, accMedium)
//                .splineToLinearHeading(new Pose2d(45,-7, Math.toRadians(-90)),         //midway by Spline to Sample4
//                        Math.toRadians(75), velFast, accMedium)
