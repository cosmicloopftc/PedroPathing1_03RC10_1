...
public class RR_2AutoRedSpecimen_PushTestParallelMove extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        preloadScore = drive.actionBuilder(beginPose)
                .setReversed(true)
                .lineToYConstantHeading(-36.5,velFast, accMedium);             //start and move to submersible pole to score
        ...
        TrajectoryActionBuilder combine_preloadMove_BackPush2SpecToHome_CollectSpec1 = preloadScore.endTrajectory().fresh()
                ...
                .splineToLinearHeading(new Pose2d(34,-45, Math.toRadians(-90)),  //spline to side before going to sample4
                ...
                .splineToLinearHeading(new Pose2d(62,-42, Math.toRadians(-90)),         //pushSample6Home, midway by Spline
