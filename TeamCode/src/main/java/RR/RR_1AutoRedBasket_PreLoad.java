...
//
//        TrajectoryActionBuilder grabPose4 = turnToBasket3.endTrajectory().fresh()
//                .setTangent(45)
//                .strafeToSplineHeading(new Vector2d(-40, -50), Math.toRadians(340))
//                .waitSeconds(0.25);
//
//        TrajectoryActionBuilder turnToBasket2 = grabPose4.endTrajectory().fresh()
//                .setTangent(45)
