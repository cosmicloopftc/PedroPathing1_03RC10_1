...
public class RR_2AutoRedSpecimenTESTPUSH extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //        .waitSeconds(0.5)
                .lineToYConstantHeading(-33, velFast, accFast);     //move to score preload
//                .setTangent(-90)
//                .strafeToSplineHeading(new Vector2d(3, -33), Math.toRadians(-90))
        ...
        TrajectoryActionBuilder preloadMoveBack= preloadScore.endTrajectory().fresh()
                .lineToYConstantHeading(-40, velFast, accFast)          //open claw before this.  move back from Submersible
                .stopAndAdd(new AutoOuttakeArmAxonAction(0.4))        //rotate arm into robot
                .stopAndAdd(new AutoOuttakeSliderAction(0, 1))     //lower intake slider
                .splineToConstantHeading(new Vector2d(21,-43),
                        Math.toRadians(270), velFast,accFast)
                .lineToYConstantHeading(-20);

        //  .strafeToSplineHeading(new Vector2d(28, -43), Math.toRadians(60), velFast, accFast);


        TrajectoryActionBuilder pushSample1Home = preloadMoveBack.endTrajectory().fresh()
                .splineToConstantHeading(new Vector2d(21,-43),
                        Math.toRadians(270))
                .lineToYConstantHeading(-30)
                .splineToConstantHeading(new Vector2d(29,-10),
                        Math.toRadians(270))
