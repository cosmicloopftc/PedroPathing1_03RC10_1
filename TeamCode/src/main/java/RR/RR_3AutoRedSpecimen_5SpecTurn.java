...
public class RR_3AutoRedSpecimen_5SpecTurn extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder combine_preloadMove_BackPush2SpecToHome_CollectSpec1 = preloadScore.endTrajectory().fresh()
                ...
                .splineToLinearHeading(new Pose2d(24,-35, Math.toRadians(60)),         //pushSample6Home, midway by Spline
           ...
           //     .waitSeconds(0.5)
                ...
                .strafeToLinearHeading(new Vector2d(42, -32), Math.toRadians(50), velFast, accMedium)
           //     .waitSeconds(0.5)
